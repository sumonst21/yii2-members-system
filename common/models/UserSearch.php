...
class UserSearch extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'email', 'firstname', 'lastname', 'auth_key', 'password_hash', 'password_reset_token', 'validation_token'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        */
        ...
        $query->andFilterWhere(['like', 'username', $this->username])
            ...
            ->andFilterWhere(['like', 'validation_token', $this->validation_token])
